...
public class MemberManager {
    ...
    private void addMember(Scanner sc, MemberDao dao) throws SQLException {
        ...
        // cf) DB의 Auto_increment 값으로 -1 을 전달할 시
        //      : 아직 DB에 저장되지 않음을 의미함
    ...
    private void updateMember(Scanner sc, MemberDao dao) throws SQLException {
        System.out.println("업데이트할 사용자 id를 입력하세요: ");
        ...
        System.out.println("사용자의 새 이름(변경하지 않으려면 엔터하세요): ");
        ...
        if (newName.isEmpty() && newEmail.isEmpty()) {
            System.out.println("변경값이 없습니다. 수정이 불가합니다. ");
            return;
        }
